...
Taq leaves through the north doors to find himself in an octagonal staircase leading down. He descends to the bottom of the staircase to see two armoured guards, with a passage to the south and doors to the east.
...
Taq comes up onto a landing with two chairs, and more stairs leading up. He takes a sealed corridor leading west (which would be over the passageway downstairs). Four doors lead north from the passageway.

The first opens into a small comfortable bedroom with a suit of armour and various weapons lying around.

The next room seems to belong to a magical user, perhaps a cleric (there are a mace and altar) but Taq does not recognise the deity. Ixona recognises the order of the temple being the one the castle had originally.

The third room is another comfortable bedroom, fancier than the previous ones. A table holds a game board and a lyre rests near the luxurious bed. There is a mirror and some perfume bottles.

The fourth and last room off the corridor holds plants, some sickles, and potting material: the bedroom of a horticulturalist.

Taq returns back downstairs and checks the rooms off the corridor: the first two consist of barracks. The third and final room has three humans who appear to spot the invisible Taq. One is a male elf with platinum-white hair, who is wearing robes. The second is a female half-elf with black curly hair and dark complexion, who also seems to be a magic caster of some sort. The final is a human guard in armour.

<figure markdown>
  <img src ="images/castle-rend-taq-spotted.png" alt="Castle Rend - Taq Spotted" width="400" />
  <figcaption>Castle Rend - Taq Spotted</figcaption>
</figure>

Taq hears one say "Did you see something?". Taq retreats outside, turns invisible, and stays over head height.

"Did you see anything weird?"

"What? Weird?"

The male elf leaves the room, looks outside, then enters again.

"I just saw... something."

Taq returns back to the staircase and back up to the library near where the party is hiding. He takes the door to the east of the room. Inside is a bedroom containing a large two-handed sword. On a table nearby are more musical instruments. A hexagonal table has something etched in chalk on it. Norgreath *(Arcana check)* thinks that it is some sort of devilish symbol. There is no sign of the identity of the room this belongs to, but it seems to be the most important bedroom we have seen so far.

We next get Taq to take the corridor to the south, leading east to a church.

In the corridor are some guards, and some bowmen looking through arrow slits into the courtyard. Halfway along the corridor are double doors to the south. Two giant ornamental statues line the south side of the corridor. Taq proceeds along the corridor near its roof.

<figure markdown>
  <img src ="images/castle-rend-south-corridor.png" alt="Castle Rend - South Corridor" width="400" />
  <figcaption>Castle Rend - South Corridor</figcaption>
</figure>

Taq looks through the double doors to the south. It seems to be a war room:

<figure markdown>
  <img src ="images/castle-rend-war-room.png" alt="Castle Rend - War Room" width="400" />
  <figcaption>Castle Rend - War Room</figcaption>
</figure>

Ixona recognises the Knight of Stars inside and shouts that [she wants to kill him immediately...](2026-07-22.md)
