...
After levelling up, the characters discuss their options. The key segments are building up. But we have one remaining, Timeborne, who we know little about it. We consider Galen casting Legend Lore to learn more, but he needs to purchase some material components: incense (that is consumed) and four ivory strips (that we retain). He asks for information about the place, Timeborne. He learns that:

- Timeborne is a small city built on the Plane Breaker that is home to extra-planar refugees and travellers.
...
Norgreath gets out his coin, the path token, and we prepare to travel. He holds it in his two hands and concentrates on Timeborne. His Arcana check is low, so he uses inspiration to roll a 19. The first thing we see from the path is strange: a mountainous landscape with a city, that appears to be moving! The city seems to be on the back of a creature.
...
We are approached by one person, who steps out from buildings to the South of us, and says: "Are you newly arrived in Timeborne?".

<figure markdown>
  <img src ="images/interpreter.png" alt="Interpreter" width="400" />
  <figcaption>Darli Kos</figcaption>
</figure>
...
"Is it known as the Tyrant of War?"
...
"An elf named Kreeger, who has been researching the topic for years. He has a reading room in the sub-basement."
...
"Hail Kreeger, well met, I am Norgreath and these are my colleagues. We have a common interest in the Tyrant of War", Norgreath says in Elvish.
...
"Well, they're pirates led by my sister Captain Zareta."
...
"My sister and I agree that I'm the best placed to block your pathetic attempts to gather the keys. Who was it who sent you? Was it Manizer? I have the knowledge of the pattern of the appearance of the Tyrant, and I have the final segment of the key."

Lunghiss piles in to attack, Barrisso can see through the illusion: he is really 5 feet to the left. Lunghiss misses. 

Barrisso points to where Kreeger is. 

Karthis casts Haste on Gralok. Barrisso shows where he is, Gralok rages and moves in, using Call the hunt. (4 people get a +D6 to their damage: Norgreath, Barrisso, Galen and Lunghiss). His first attack misses. His second hits, he adds Infectious Fury, 9+22 damage. His third attack hits, again with infectious fury that he saves.
...
Kreeger teleports to behind Norgreath and deals a critical doing 67HP of damage. Norgreath saves against poison and is resistant, so only takes +5 damage from the blade. The next attack misses.

Norgreath casts Armour of Agathys on himself, gaining temporary hit points and creating an automatic reaction attack if he is hit again in melee.
...
Kreeger pulls out a scroll. He casts Synaptic Static – the area includes everyone. It requires an INT save of 20. Succeed is 10 damage, Fail is 20 plus befuddled thoughts. [Only Gralok fails, despite using inspiration to re-roll](2026-06-10.md).
