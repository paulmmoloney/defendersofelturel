...
We move into the second room, where there is a door to the south. As we approach it, we see coming from under it an oozing creature. Two other similar creature appear from under the tables.
...
Gralok attacks with his Blazing Cold Greataxe. His (slashing) attack splits the jelly in two without doing damage. There are now three jellies again. He changes to his Raggadragga's Maul, and does 8HP of bludgeoning damage.
...
Inside the room are carcasses hanging off hooks from the ceiling: porcine, bovine, and some unfamiliar to us, in a cold room like somewhere used to store meat:
...
We see a door out of this room to the east and cross to it. Despite the intense cold, we make across it safely but we are all streaked with lard. We enter the next room.

Hanging from racks in this room are all manner of metallic pots and pans. Open cupboards display trays and crockery. Wooden and metal utensils cover the floor. Firepits are set into the walls. On the southernmost wall are hanging cleaver and knives. A staircase on the northside of the room lead upwards, and a door leads east.
