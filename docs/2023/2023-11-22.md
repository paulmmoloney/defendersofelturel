...
<figure markdown>
  ![Baldur's Monthly](./images/baldurs-monthly.png){ width="800" }
...
<figure markdown>
  ![Poisoned Poseidon - Main Deck](./images/poisoned-poseidon-main-deck.png){ width="800" }
...
<figure markdown>
  ![Myrkul Cultist](./images/guy-with-skull.jpg){ width="400" }
