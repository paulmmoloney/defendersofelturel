...
"It is located further up the valley. In the elder days, the giants built a forge that took power from a fallen star. It has been millennia since the giants. They fought with the dragons, and they were almost all destroyed. The Fomorians have kept the Star Forge somewhat active. But as the magic of the world fails, it too fails."
