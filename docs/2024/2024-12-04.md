...
We reach the bridge across the Styx that we encountered in an earlier crossing: one with engravings telling the story of Zariel. We cross the bridge - as we get to the far side of the bridge, we look up and see an absolutely enormous flying structure like an inverted hook or sword, ploughing the landscape. We make an educated guess that this is Zariel's flying fortress:
