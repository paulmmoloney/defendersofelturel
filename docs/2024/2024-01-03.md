...
<figure markdown>
  ![Bathhouse with Secret Stairs](./images/bathhouse-with-secret-stairs.png){ width="800" }
...
<figure markdown>
  ![Bathhouse Underground](./images/bathhouse-underground.png){ width="800" }
...
<figure markdown>
  ![Bathhouse - Bane Room](./images/bathhouse-bane-room.png){ width="800" }
